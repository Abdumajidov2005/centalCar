            ...
            <nav class="navbar navbar-expand-lg navbar-light">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav mx-auto py-0">
                        ...
                        ?>
                                <a href="<?= $row['izoh'] ?>" class="nav-item nav-link"><?= $row['title'] ?></a>
                        <?php }
                        }
                        ?>
                    </div>
                    <a href="admin/index.php" class="btn btn-primary rounded-pill py-2 px-4">Admin sahifasi</a>
                </div>
            </nav>
        </div>
    </div>
